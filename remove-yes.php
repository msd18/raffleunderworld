...
if ($isverr == "0")
{
die("<b><font size='4'>We have no SMS Settings on record for you.<br><br><a href='index.php'>home</a></font></b><br><br>");
} else {
?><br>
<fb:success message="Your Cellphone # has been removed!" /><br><br><br><br><a href='index.php'><font size='4'>home</font></a><br><br><br>
<?
mysql_query("UPDATE main SET isverified='0' WHERE fbuser='$fbid'") 
or die(mysql_error()); 
}
?>
